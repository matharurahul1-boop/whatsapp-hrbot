...
const NAV: NavItem[] = [
  { href: '/dashboard',  label: 'Dashboard',  icon: <LayoutDashboard className="h-[18px] w-[18px]" />, roles: ['super_admin','admin','hr','manager'],           color: 'text-brand-400'  },
  ...
  { href: '/leave',      label: 'Leave',       icon: <Calendar        className="h-[18px] w-[18px]" />, roles: ['super_admin','admin','hr','manager'],           color: 'text-amber-400'  },
  { href: '/attendance', label: 'Attendance',  icon: <Clock           className="h-[18px] w-[18px]" />, roles: ['super_admin','admin','hr','manager'],           color: 'text-cyan-400'   },
